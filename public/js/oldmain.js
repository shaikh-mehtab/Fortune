 ...
 (function ($) {
  ...
  $(document).on("click", ".submit", function () {
    ...
    if (!error && actionURL != "" && actionURL != undefined) {
      ...
      console.log(formData,redirectVal);
      $.ajax({
        type: "POST",
        url: actionURL,
        data: formData,
